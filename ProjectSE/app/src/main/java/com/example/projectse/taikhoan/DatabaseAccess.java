...
public class DatabaseAccess {
    ...
    public Boolean capnhatdiem(String taikhoan,int Point, int PointPlus){
        db = openHelper.getWritableDatabase();
        ContentValues contentValues = new ContentValues();
...
//    public void LayUser(NguoiDung user, String username)
//    {
//        db = openHelper.getWritableDatabase();
//        Cursor cursor = db.rawQuery("SELECT * FROM NguoiDung WHERE TaiKhoan = ?",new String[]{String.valueOf(username)});
//        cursor.moveToNext();
