...
public class BoBaiNgheAdapter extends BaseAdapter {
    private Context context;
    private int layout;
    private List<BoHocTap> boHocTapList;

    public BoBaiNgheAdapter(Context context, int layout, List<BoHocTap> boCauHoiList) {
        this.context = context;
        this.layout = layout;
        this.boHocTapList = boCauHoiList;
    }
